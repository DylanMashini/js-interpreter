...
<div class="flex flex-col h-screen bg-gray-900 text-gray-100 p-4">
  ...
  <p>This is a interactive playground for the JS interpreter I wrote. When you execute code, it doesn't run in the browser's runtime. Instead, it runs in a runtime I wrote in Rust and compiled to WASM. The source code is available <a href="https://github.com/DylanMashini/js-interpreter" target="_blank" rel="noreferer noopener" class="text-blue-400 underline">on GitHub</a>.</p> <br>
